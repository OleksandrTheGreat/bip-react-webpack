...
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_17__, __WEBPACK_EXTERNAL_MODULE_80__) {
...
var bus_1 = __webpack_require__(16);
exports.bus = bus_1.bus;
var i18n_1 = __webpack_require__(14);
exports.i18n = i18n_1.i18n;
var state_1 = __webpack_require__(76);
exports.state = state_1.state;
var ioc_1 = __webpack_require__(75);
exports.ioc = ioc_1.ioc;
var pages_1 = __webpack_require__(9);
...
var DeleteCurrency = (function () {
    function DeleteCurrency(currency, onSuccess, onError) {
...
var UnDeleteCurrency = (function () {
    function UnDeleteCurrency(currency, onSuccess, onError) {
        this.currency = currency;
        this.onSuccess = onSuccess;
        this.onError = onError;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
var HomePage_1 = __webpack_require__(50);
var SettingsPage_1 = __webpack_require__(53);
var CurrencyListPage_1 = __webpack_require__(45);
var CurrencyPage_1 = __webpack_require__(47);
var AccountsListPage_1 = __webpack_require__(42);
var AccountPage_1 = __webpack_require__(39);
var AboutPage_1 = __webpack_require__(37);
exports.pages = {
...
var FormTextAreaField = (function (_super) {
    ...
    FormTextAreaField.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "row" },
            ...
            React.createElement("div", { className: "col" }, TextArea)));
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var Account_1 = __webpack_require__(61);
exports.Account = Account_1.Account;
var Currency_1 = __webpack_require__(62);
exports.Currency = Currency_1.Currency;
var Marker_1 = __webpack_require__(63);
exports.Marker = Marker_1.Marker;
var Transaction_1 = __webpack_require__(64);
...
Object.defineProperty(exports, "__esModule", { value: true });
var i18n_menu_1 = __webpack_require__(70);
var i18n_settings_1 = __webpack_require__(71);
var i18n_currency_list_1 = __webpack_require__(68);
var i18n_accounts_list_1 = __webpack_require__(66);
var i18n_common_1 = __webpack_require__(67);
var i18n_currency_1 = __webpack_require__(69);
var i18n_account_1 = __webpack_require__(65);
var i18nEN = (function () {
    function i18nEN() {
        this.locale = 'en-US';
...
var AccountModel = (function () {
    function AccountModel(id, name, balance, currencyId, currency, showOrder, description) {
        if (balance === void 0) { balance = null; }
        if (currencyId === void 0) { currencyId = null; }
        if (currency === void 0) { currency = null; }
        if (showOrder === void 0) { showOrder = -1; }
...
Object.defineProperty(exports, "__esModule", { value: true });
var abus_1 = __webpack_require__(79);
...
Object.defineProperty(exports, "__esModule", { value: true });
var shared_1 = __webpack_require__(1);
var account_commands_1 = __webpack_require__(7);
(function () {
    ...
    shared_1.bus.Handle(account_commands_1.QueryDashboardAccounts, function (command) {
        _repository
            .query('Account', function (account) { return !account.isDeleted && account.showOnHomePage; })
...
Object.defineProperty(exports, "__esModule", { value: true });
var shared_1 = __webpack_require__(1);
var currency_commands_1 = __webpack_require__(3);
var xtypescript_1 = __webpack_require__(10);
(function () {
    ...
    shared_1.bus.Handle(currency_commands_1.SaveCurrency, function (command) {
        command.currency.id = command.currency.id || xtypescript_1.GUID.New();
        repository
            .update('Currency', command.currency)
            .then(function () { return command.onSuccess(); })
            .catch(function (e) { return command.onError(e); });
    ...
    shared_1.bus.Handle(currency_commands_1.QueryCurrencyList, function (command) {
        repository
            ...
            var result = currencyList.sort(function (a, b) {
                if (a.name > b.name)
                    return 1;
                if (a.name < b.name)
                    return -1;
...
var React = __webpack_require__(0);
var shared_1 = __webpack_require__(1);
var Error_1 = __webpack_require__(26);
var Menu_1 = __webpack_require__(29);
var View_1 = __webpack_require__(54);
var Modals_1 = __webpack_require__(36);
...
var React = __webpack_require__(0);
var shared_1 = __webpack_require__(1);
var LanguageItem_1 = __webpack_require__(28);
var commands_1 = __webpack_require__(2);
var LanguageBar = (function (_super) {
    ...
    LanguageBar.prototype.render = function () {
        var en = React.createElement("img", { src: __webpack_require__(77) });
        var ua = React.createElement("img", { src: __webpack_require__(78) });
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var MenuBrandIcon_1 = __webpack_require__(30);
var MenuToggleButton_1 = __webpack_require__(32);
var Nav_1 = __webpack_require__(33);
var LanguageBar_1 = __webpack_require__(27);
...
var React = __webpack_require__(0);
var shared_1 = __webpack_require__(1);
var MenuItem_1 = __webpack_require__(31);
var commands_1 = __webpack_require__(2);
var events_1 = __webpack_require__(4);
...
Object.defineProperty(exports, "__esModule", { value: true });
var AskModal_1 = __webpack_require__(34);
exports.AskModal = AskModal_1.AskModal;
var ErrorModal_1 = __webpack_require__(35);
...
var AboutPage = (function (_super) {
    ...
    AboutPage.prototype.render = function () {
        return (React.createElement("div", null, shared_1.state.i18n.menu.about));
    };
    return AboutPage;
}(React.Component));
...
var index_1 = __webpack_require__(2);
var Form_2 = __webpack_require__(8);
var currency_commands_1 = __webpack_require__(3);
var FormTextAreaField_1 = __webpack_require__(12);
...
var AccountForm = (function (_super) {
    ...
    AccountForm.prototype.render = function () {
        ...
        var currencyOptionField = this.state.data.account.id == null
            ? React.createElement(Form_2.FormOptionsField, { title: shared_1.state.i18n.account.currency, values: this.state.data.currencyList, selectedValue: this.state.data.account.currencyId, onChange: function (e) { return _this.onChange(function (model) { return model.account.currencyId = e.target.value; }); } })
            : React.createElement(Form_1.FormReadOnlyField, { title: shared_1.state.i18n.account.currency, value: this.props.data.account.currency });
    ...
    AccountForm.prototype._refreshCurrencyList = function () {
        ...
        shared_1.bus.SendAsync(new currency_commands_1.QueryCurrencyList(function (list) {
            _this.setState(function (state) {
                return {
                    data: __assign({}, state.data, { currencyList: list
...
var AccountForm_1 = __webpack_require__(38);
    ...
    AccountPage.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(Header_1.Header, null,
                ...
                title),
            React.createElement(AccountForm_1.AccountForm, { data: {
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var AccountItem_1 = __webpack_require__(40);
...
var AccountsList = (function (_super) {
    ...
    AccountsList.prototype.render = function () {
        var list = [
            new AccountModel_1.AccountModel(null, null)
...
var shared_1 = __webpack_require__(1);
var Header_1 = __webpack_require__(5);
var AccountsList_1 = __webpack_require__(41);
var account_commands_1 = __webpack_require__(7);
var index_1 = __webpack_require__(2);
...
var CurrencyItem = (function (_super) {
    ...
    CurrencyItem.prototype._onDeleteClick = function () {
        ...
        shared_1.bus.SendAsync(new commands_1.Ask(shared_1.state.i18n.currency.deleteQuestion.replace('{0}', this.props.currency.name), function (answer) {
            shared_1.bus.SendAsync(new currency_commands_1.DeleteCurrency(_this.props.currency, function () {
    ...
    CurrencyItem.prototype._onUnDeleteClick = function () {
        ...
        shared_1.bus.SendAsync(new commands_1.Ask(shared_1.state.i18n.currency.undeleteQuestion.replace('{0}', this.props.currency.name), function (answer) {
            shared_1.bus.SendAsync(new currency_commands_1.UnDeleteCurrency(_this.props.currency, function () {
                shared_1.bus.SendAsync(new currency_commands_1.RefreshCurrencyListPage());
            }, function (error) {
                shared_1.bus.SendAsync(new commands_1.ShowError(shared_1.state.i18n.common.defaulErrorMessage));
            }));
...
var CurrencyItem_1 = __webpack_require__(43);
var CurrencyList = (function (_super) {
    ...
    CurrencyList.prototype.render = function () {
        var list = [
            new domain_1.Currency(null, null)
...
var shared_1 = __webpack_require__(1);
var Header_1 = __webpack_require__(5);
var CurrencyList_1 = __webpack_require__(44);
var currency_commands_1 = __webpack_require__(3);
var index_1 = __webpack_require__(2);
...
var shared_1 = __webpack_require__(1);
var Header_1 = __webpack_require__(5);
var CurrencyForm_1 = __webpack_require__(46);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var AccountItem_1 = __webpack_require__(48);
...
var React = __webpack_require__(0);
var shared_1 = __webpack_require__(1);
var AccountList_1 = __webpack_require__(49);
var account_commands_1 = __webpack_require__(7);
var commands_1 = __webpack_require__(2);
...
var shared_1 = __webpack_require__(1);
var commands_1 = __webpack_require__(2);
var SettingsItem_1 = __webpack_require__(51);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var SettingsList_1 = __webpack_require__(52);
...
var FormNumberField = (function (_super) {
    ...
    FormNumberField.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "row" },
            React.createElement("div", { className: "col va-middle" },
                React.createElement("label", null, this.props.title)),
            React.createElement("div", { className: "col" }, Input)));
    };
...
var FormReadOnlyField = (function (_super) {
    ...
    FormReadOnlyField.prototype.render = function () {
        return (React.createElement("div", { className: "row" },
            React.createElement("div", { className: "col va-middle" },
                React.createElement("label", null, this.props.title)),
            React.createElement("div", { className: "col" }, this.props.value)));
    };
...
var Account = (function (_super) {
    ...
    function Account(id, name, currencyId, balance, description, showOnHomePage, showOrder, useInBalance) {
        if (balance === void 0) { balance = 0; }
        if (description === void 0) { description = null; }
        if (showOnHomePage === void 0) { showOnHomePage = false; }
        if (showOrder === void 0) { showOrder = 0; }
...
var Currency = (function (_super) {
    ...
    function Currency(id, name, precision, description) {
...
var Marker = (function (_super) {
    ...
    function Marker(id, category, name) {
        var _this = _super.call(this, id) || this;
...
var Transaction = (function (_super) {
    ...
    function Transaction(id, fromAccountId, toAccountId, sumFrom, sumTo, rate, description) {
...
var i18nAccountEN = (function () {
    function i18nAccountEN() {
        ...
        this.constraintErrorMessage = 'Account {0} already exists';
        ...
        return new Promise(function (resolve, reject) {
            _this
                ...
                var result = accounts.map(function (account) {
                    ...
                    var balance = account.balance.toLocaleString(shared_1.state.i18n.locale, {
                        style: 'decimal',
                        minimumFractionDigits: currency.precision
                    });
                    return new AccountModel_1.AccountModel(account.id, account.name, balance, currency.id, currency.name, account.showOrder, account.description);
                });
                resolve(result);
            })
                .catch(function (e) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var xtypescript_1 = __webpack_require__(10);
var IDBAdapter_1 = __webpack_require__(20);
var domain_1 = __webpack_require__(13);
...
Object.defineProperty(exports, "__esModule", { value: true });
var IDBRepository_1 = __webpack_require__(21);
var db_1 = __webpack_require__(74);
var AccountMapper_1 = __webpack_require__(73);
